...
class NotifyBarangMasukCreated implements ShouldQueue
{
    ...
    public function __construct(int $id_brg_masuk)
    {
    ...
    public function handle(): void
    {
        ...
        $tglMasuk = optional($barang->tanggal)->format('Y-m-d') ?? '-';
        $textPesan = "Barang Masuk Baru\n"
            . "Tanggal : {$tglMasuk}\n"
